...
function App() {
  ...
  return (
    <>
      <div className="border border-white rounded-lg min-w-[100%] max-w-[608px] h-fit m-auto px-8 py-4 bg-white drop-shadow-lg shadow-[hsl(292,16%,49%)]">
        <div>
          <header className="flex items-center justify-start gap-4 pt-5 pb-5">
            <span>
              <IconStar />
            </span>
          ...
          <main>
            ...
            {faqData.map((item, index) => {
              return (
                <div key={index}>
                  <button
                    className={`w-[100%] flex items-center justify-between pt-6 pb-6 cursor-pointer  font-semibold text-wrap ${
                      activeIndex === index
